...
<!-- <section id="title-header">
  <div class="title">  
     <img class="logo" src""> <br>
      <br>
      <p class="subtitle">Star Teach E-Learning System</p> 
  </div>
</section>  -->
 <div class="container" style="min-height: 500px;">  
      <p class="page-header" style="font-style: italic; font-weight: 900; font-family: Cooper Black;font-size: 40px">Sign Up</p>
      <?php check_message(); ?>
    <div id="login-dp">
 <form class="form-horizontal span6" action="" method="POST" enctype="multipart/form-data" id="login-nav" style="font-family:comic Sans MS;font-size: 15px;">
...
?>
   ...
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color: black; color:#fff;">
              <p align="center">&copy; StarTech E-Learning System</p>
     </footer>
