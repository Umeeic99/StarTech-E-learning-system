...
INSERT INTO `tblcontactus` (`ContactusID`, `Fname`, `Email`, `Subject`, `MobileNo`, `Description`) VALUES
(1, 'Umar', 'umerkhalid@gmail.com', 'Not showing score', '21', 'Click on button but score not show'),
(2, 's', 'sad', 'sad', '231', 'a');

CREATE TABLE `tblreportus` (

  `ReportusID` int(11) NOT NULL,
  `Fname` varchar(90) NOT NULL,
  `Email` varchar(90) NOT NULL,
  `Subject` varchar(90) NOT NULL,
  `MobileNo` varchar(90) NOT NULL,
  `Description` varchar(90) NOT NULL,
  PRIMARY KEY (ReportusID)

) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;

INSERT INTO `tblreportus` (`ReportusID`, `Fname`, `Email`, `Subject`, `MobileNo`, `Description`) VALUES
(1, 'Umar', 'umerkhalid@gmail.com', 'Not showing score', '21', 'Click on button but score not show'),
(2, 's', 'sad', 'sad', '231', 'a');
--
...
ALTER TABLE `tblstudent`
  ...
  ADD PRIMARY KEY (`ContactusID`) USING BTREE;
ALTER TABLE `tblreportus`
  ADD PRIMARY KEY (`ReportusID`) USING BTREE;
...
ALTER TABLE `tblcontactus`
  ...
  MODIFY `ReportusID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
